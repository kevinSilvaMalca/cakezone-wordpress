...
/**
 * Class Lafka_WC_Variation_Swatches_Frontend
 */
class Lafka_WC_Variation_Swatches_Frontend {
	/**
	 * The single instance of the class
	 *
	 * @var Lafka_WC_Variation_Swatches_Frontend
	 */
	...
	public function get_swatch_html( $html, $args ) {
		...
		if ( array_key_exists( $attr->attribute_type, $swatch_types ) ) {
			...
			if ( ! empty( $swatches ) ) {
				...
				$swatches = '<div class="lafka-wcs-swatches" data-attribute_name="attribute_' . esc_attr( $attribute ) . '">' . $swatches . '</div>';
