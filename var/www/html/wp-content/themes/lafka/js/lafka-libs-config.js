(function ($) {
	...
	$(window).load(function () {
		 ...
		 *****************************/
		if (typeof lafka_masonry_settings !== 'undefined') {
		...
		if (typeof lafka_owl_carousel_cat !== 'undefined') {
			...
			$(".lafka_woo_categories_shop.lafka-owl-carousel", "#main").owlCarousel({
				...
				responsive: {
                    ...
                    768: {
                        items: (lafka_owl_carousel_cat.columns < 3 ? lafka_owl_carousel_cat.columns : "3"),
                    },
                    1024: {
                        items: (lafka_owl_carousel_cat.columns < 4 ? lafka_owl_carousel_cat.columns : "4"),
                    },
					1280: {
						items: lafka_owl_carousel_cat.columns,
					}
				},
				dots: false,
				loop: false,
...
if (typeof lafka_quickview !== 'undefined') {
    ...
    ;(function ($, window, document, undefined) {
        ...
        var LafkaVariationForm = function ($form) {
            ...
            var $quantityPlus = $form.find('input.lafka-qty-plus');
            var $quantityMinus = $form.find('input.lafka-qty-minus')
         ...
         */
        LafkaVariationForm.prototype.onFindVariation = function (event) {
            var form = event.data.variationForm,
