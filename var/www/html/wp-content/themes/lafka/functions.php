		...
		function lafka_post_nav($same_category = false, $taxonomy = 'category') {
			...
			switch ($type) {
                ...
                case 'product':
	                ...
	                break;
				case 'lafka-foodmenu':
					$post_type_label = ' '.esc_html__('project', 'lafka');
					break;
                default:
	                $post_type_label = '';
            }
...
if ( ! function_exists( 'lafka_build_mobile_menu_items_wrap' ) ) {
	function lafka_build_mobile_menu_items_wrap() {
        ...
        <ul class="lafka-mobile-menu-tabs">
	        ...
	        <?php if (lafka_should_show_account_icon() && wp_is_mobile() && (is_user_logged_in() || (!is_user_logged_in() && !has_shortcode($post->post_content, 'woocommerce_my_account')))): ?>
                <li>
