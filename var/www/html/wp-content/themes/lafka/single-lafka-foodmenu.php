			...
			<div id="main" class="fixed box box-common">
				<div class="content_holder">
					...
					<?php if (!$lafka_use_custom_content): ?>
						<div class="foodmenu_top<?php if ($lafka_prtfl_gallery == 'list'): ?> lafka_image_list_foodmenu<?php endif; ?>" >
							<?php if(!lafka_get_option('hide_foodmenu_images')):?>
                                <div class="two_third foodmenu-main-image-holder">
                                    <?php if ($lafka_prtfl_gallery == 'cloud' && has_post_thumbnail()): ?>
                                        ...
                                        $lafka_image_title = the_title_attribute(array('post' => get_post_thumbnail_id(), 'echo' => false));
                                        ...
                                        ?>
                                        <?php echo sprintf('<a id="zoom1" href="%s" itemprop="image" class="cloud-zoom " title="%s"  rel="position: \'inside\' , showTitle: false, adjustX:-4, adjustY:-4">%s</a>', esc_url($lafka_image_link), esc_attr($lafka_image_title), $lafka_image); ?>
                                        ...
                                        <?php if (!empty($lafka_featured_flex_slider_imgs)): // If there are additional images show CloudZoom gallery  ?>
                                            <ul class="additional-images">
                                                <?php foreach ($lafka_featured_flex_slider_imgs as $lafka_img_id): ?>
                                                    <?php
                                                    $lafka_image_title = the_title_attribute(array('post' => $lafka_img_id, 'echo' => false));
                                                    ...
                                                    ?>
                                                    <li>
                                                        <?php echo sprintf('<a rel="useZoom: \'zoom1\', smallImage: \'%s\'" title="%s" class="cloud-zoom-gallery" href="%s">%s</a>', esc_url($lafka_small_image_link), esc_attr($lafka_image_title), esc_url($lafka_image_link), $lafka_thumb_image); ?>
                                                    </li>
                                                <?php endforeach; ?>
                                            </ul>
                                        <?php endif; ?>
                                    ...
                                    <?php elseif ($lafka_prtfl_gallery == 'list' && has_post_thumbnail()): ?>
                                        ...
                                        <div class="lafka_image_list">
                                            <?php if (has_post_thumbnail()): ?>
                                                ...
                                                <?php $lafka_image_title = the_title_attribute(array('post' => get_post_thumbnail_id(), 'echo' => false)); ?>
                                                <?php $lafka_img_tag = wp_get_attachment_image(get_post_thumbnail_id(), 'lafka-foodmenu-single-thumb'); ?>
                                                <?php echo sprintf('<a href="%s" class="lafka-magnific-gallery-item" title="%s" >%s</a>', esc_url($lafka_attach_url), esc_attr($lafka_image_title), $lafka_img_tag); ?>
                                            <?php endif; ?>
                                            <?php foreach ($lafka_featured_flex_slider_imgs as $lafka_img_att_id): ?>
                                                <?php $lafka_attach_url = wp_get_attachment_url($lafka_img_att_id); ?>
                                                <?php $lafka_image_title = the_title_attribute(array('post' => $lafka_img_att_id, 'echo' => false)); ?>
                                                    ...
                                                    <li class="lafka-foodmenu-nutrition-list">
                                                        <ul>
															<?php foreach ( $lafka_nutrition_list as $lafka_nutrition_name => $lafka_nutrition_value ): ?>
                                                                <li <?php if ( $lafka_nutrition_name === 'lafka_nutrition_energy' ): ?> class="lafka-nutrition-energy" <?php endif; ?> >
					...
					<?php if ($post->post_content != ""): ?>
						<div class="full_width lafka-project-description<?php if ( $lafka_use_custom_content ) echo ' lafka-custom-content' ?>">
							<?php the_content(); ?>
						</div>
					<?php endif; ?>
					<?php
					...
					if (array_key_exists(0, $lafka_foodmenu_categories)) {
						...
						$lafka_get_foodmenu_args['tax_query'] = array(array('taxonomy' => 'lafka_foodmenu_category', 'field' => 'slug', 'terms' => $lafka_foodmenu_first_category));
					}
                                ...
                                <h4>
                                    ...
                                    <?php if ( $lafka_foodmenu_first_category !== null ): ?>
                                        <a class="lafka-related-browse"
                                           ...
                                           title="<?php echo sprintf( esc_attr__( 'Browse more "%s"', 'lafka' ), $lafka_foodmenu_first_category->name ) ?>">
										...
										<div class="foodmenu-unit-holder">
                                            ...
                                            <div class="foodmenu-unit-info">
                                                <a <?php if(!lafka_get_option('foodmenu_simple_menu')):?> title="<?php esc_attr_e('View more', 'lafka') ?>" <?php endif; ?>
                                                   href="<?php if(!lafka_get_option('foodmenu_simple_menu')) the_permalink(); else echo '#' ?>"
                                                   class="foodmenu-link">
                                                    <h4>
                                                        <?php the_title(); ?>
