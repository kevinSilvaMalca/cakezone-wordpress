...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( implode(' ', $lafka_product_classes), $product ); ?>>
    <div class="content_holder">
        ...
        ?>
        <div class="lafka-product-summary-wrapper<?php if(!empty($lafka_single_product_gallery_classes)) echo " " . implode(" ", $lafka_single_product_gallery_classes) ?>">
	        ...
	        if ( function_exists( 'lafka_get_product_addons' ) && lafka_get_option( 'product_addons' ) === 'enabled' ) {
		        $lafka_has_product_addon = count( lafka_get_product_addons( get_the_ID() ) );
	        }
	        ?>
