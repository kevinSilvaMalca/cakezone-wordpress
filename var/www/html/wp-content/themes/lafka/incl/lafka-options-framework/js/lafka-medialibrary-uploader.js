...
(function ($) {
    $(document).ready(function () {
        ...
        jQuery('.lafka_upload_image_button').on('click', function (event) {
        ...
        jQuery('a.lafka_remove_image_link').on('click', function (event) {
         ...
         * Delete sidebar
         */
        $('#lafka_custom_sidebars_list').delegate('.lafka_del_sdbr', 'click', function (event) {
            event.preventDefault();
