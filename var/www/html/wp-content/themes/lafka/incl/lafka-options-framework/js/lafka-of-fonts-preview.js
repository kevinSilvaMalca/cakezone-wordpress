jQuery(document).ready(function () {
	...
	jQuery('#body_font_size,#body_font_face').change(function () {
	...
	jQuery('#headings_font_face').change(function () {
	...
	jQuery('#h1_font_size,#h1_font_style').change(function () {
	...
	jQuery('#h2_font_size,#h2_font_style').change(function () {
	...
	jQuery('#h3_font_size,#h3_font_style').change(function () {
	...
	jQuery('#h4_font_size,#h4_font_style').change(function () {
	...
	jQuery('#h5_font_size,#h5_font_style').change(function () {
	...
	jQuery('#h6_font_size,#h6_font_style').change(function () {
