 ...
 */
if (!function_exists('lafka_optionsframework_medialibrary_uploader')) {

	function lafka_optionsframework_medialibrary_uploader($_id, $_value, $_mode = 'full', $_desc = '', $_postid = 0, $_name = '') {
		...
		$output .= '<input id="upload_' . esc_attr($id) . '" class="lafka_upload_button button" type="button" value="' . esc_attr__('Upload', 'lafka') . '" rel="' . esc_attr($int) . '" />' . "\n";
...
if (!function_exists('lafka_medialibrary_uploader')) {
	...
	function lafka_medialibrary_uploader($_id, $_value, $_mode = 'full', $_desc = '', $_postid = 0, $_name = '', $is_multiple = false) {
		...
		$output .= '<input id="upload_' . esc_attr($id) . '" class="lafka_upload_image_button button ' . esc_attr($multiple_images_class) . '" type="button" value="' . esc_attr__('Manage images', 'lafka') . '" rel="' . esc_attr($int) . '" />' . "\n";
		$output .= '<a id="' . esc_attr($id) . '_remove_link" ' . ($value ? '' : 'style="display:none"') . ' class="lafka_remove_image_link" href="#" >' . esc_attr__('Remove Image(s)', 'lafka') . '</a>';
