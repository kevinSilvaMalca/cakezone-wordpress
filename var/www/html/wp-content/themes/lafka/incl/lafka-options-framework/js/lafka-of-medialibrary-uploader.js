...
(function ($) {
    ...
    lafka_optionsframeworkMLU = {
        ...
        mediaUpload: function () {
            ...
            var formfield,
                ...
                tbframe_interval;
            // On Click
            $('input.lafka_upload_button').on("click", function (e) {
    ...
    }; // End lafka_optionsframeworkMLU Object // Don't remove this, or the sky will fall on your head.

    /*-----------------------------------------------------------------------------------*/
    /* Execute the above methods in the lafka_optionsframeworkMLU object.
     /*-----------------------------------------------------------------------------------*/

    $(document).ready(function () {

        lafka_optionsframeworkMLU.removeFile();
        lafka_optionsframeworkMLU.recreateFileField();
        lafka_optionsframeworkMLU.mediaUpload();
